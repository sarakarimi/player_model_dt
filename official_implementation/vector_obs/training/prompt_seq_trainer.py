...
from official_implementation.vector_obs.prompt_utils import flatten_prompt
import copy
...
class PromptSequenceTrainer:
    ...
    def eval_iteration_multienv(self, get_prompt, prompt_trajectories_list, eval_episodes, env_name_list, info,
        ...
        for env_id, env_name in enumerate(env_name_list):
            ...
            self.get_prompt = get_prompt(prompt_trajectories_list[env_id], info[str(env_name)], variant)
            if not no_prompt:
