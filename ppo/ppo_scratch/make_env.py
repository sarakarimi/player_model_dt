...
def make_env(config: EnvironmentConfig, seed: int, idx: int, run_name: str, mode: str, easy_env: bool):
    ...
    def thunk():
        ...
        # env = metal_grid_env()
        env = MiniGridThreeStyles(target_style=mode, target_bonus=0.6, non_target_penalty=-0.1, easy_env=easy_env, **kwargs)
