...
def make_env(config: EnvironmentConfig, seed: int, idx: int, run_name: str, mode: str):
    ...
    def thunk():
        ...
        # env = MiniGridThreeStyles(render_mode=config.render_mode, target_style=None, style_bonuses={"bypass":0.2, "backstab":0.3, "weapon":0.3})
